    ...
    return (
        <div className="mySite_container"> 
            <div className="my_site">            
               ...
               <div className="mySite_images bzsp">
                    
                    <div><img className="img1" src={require('../../../image/sites/parkaveniu/bzsp1.png')}/></div>
                    <div><img className="img1" src={require('../../../image/sites/parkaveniu/bzsp.png')}/></div>
               </div>
            </div>
        </div>
    ) 
